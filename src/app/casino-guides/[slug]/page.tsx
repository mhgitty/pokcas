...
export default async function CasinoGuidePage({ params }: Props) {
  ...
  const breadcrumbs = [
    { label: 'Home', href: '/' },
    { label: 'Casino guides', href: '/casino-guides/' },
    { label: guide.title },
  ]
  ...
  const jsonLd = {
    ...
    '@graph': [
      ...
      { '@type': 'WebPage', '@id': `${canonical}#webpage`, url: canonical, name: replaceDateVars(guide.title), inLanguage: 'en-GB', publisher: { '@type': 'Organization', name: 'Pokcas', url: BASE } },
    ],
  }
