...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!provider) return {}
  const title = `${provider.name} Casinos Australia — best ${provider.name} online casinos`
  const description = `Find the best Australian online casinos powered by ${provider.name}. Compare bonuses and ratings.`
