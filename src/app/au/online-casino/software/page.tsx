...
import { getPageByPathAu, getSoftwareProvidersAu, getSiteSettings } from '@/lib/sanity'
...
const CANONICAL = `${BASE}/au/online-casino/software/`
      ...
      {(providers as any[]).length > 0 && (
        <div className="section" style={{ paddingBottom: page.body ? '0' : undefined }}>
          <SoftwareProvidersGrid
            ...
            hrefPrefix="/au/online-casino/software"
          />
        </div>
      )}
