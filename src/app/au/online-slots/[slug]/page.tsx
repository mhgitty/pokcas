...
import { getSlotmachineBySlugAu, client } from '@/lib/sanity'
  ...
  return (
    <>
      ...
      <div style={{ background: 'var(--bg-hero)', paddingTop: '32px', paddingBottom: '32px', borderBottom: '1px solid var(--border)' }}>
        <div className="article-layout" style={{ paddingTop: 0, paddingBottom: 0 }}>
      ...
      <div className="article-layout">
        <div className="article-content">
          ...
          {hasBody && (
            <div id="review" className="section" style={{ scrollMarginTop: '80px' }}>
